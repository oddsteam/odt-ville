...
#
# god-channel (known): this one class also carries the map-wide cards seed
# (#317) and standee (#375) streams — see CARD_STREAM / standee_stream below.
# They stay here for now, documented rather than split, because both are
# map-scoped fanout that rides the same authenticated connection and access
# gate as presence. Voice signalling used to live here too, until #517.
module GameSession

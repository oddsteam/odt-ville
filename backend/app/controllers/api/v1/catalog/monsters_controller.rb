  ...
  module V1
    module Catalog
      class MonstersController < BaseController
        ...
        def index
          monsters = ::Catalog::Monster.order(:name)
          total = ::Catalog::Monster.enabled_rate_total
          render json: monsters.map { |m| ::Catalog::MonsterSerializer.summary(m, total) }
        end
        ...
        def show
          render json: ::Catalog::MonsterSerializer.call(::Catalog::Monster.find(params[:id]))
        end
        ...
        def update
          monster = ::Catalog::Monster.find(params[:id])
        ...
        def destroy
          ::Catalog::Monster.find(params[:id]).destroy!
          head :no_content
        end
      end
    end
